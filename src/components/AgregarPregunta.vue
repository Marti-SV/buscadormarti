...
export default {
  ...
  methods: {
    ...
    afegirPregunta() {
      fetch(
        `http://localhost:4000/addPregunta?title=${this.data.title}&poster=${
          this.data.poster
        }&answers=${this.data.answers}&correctIndex=${
          this.data.correctIndex - 1
        }`,
        {
          method: "POST",
          mode: "cors",
  ...
  <div>
    ...
    <v-sheet class="grid" align="center">
      ...
      >
        ...
        <v-img height="10" cover style="border-top: black"> </v-img>
